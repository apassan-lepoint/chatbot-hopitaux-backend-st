...
class SpecialtyDetectionResult:
    ...
    def __init__(self, specialty: str, detection_method: str = "unknown"):
        ...
        self.is_multiple = len(self.specialty_list) > 1
        self.is_no_match = not self.specialty or self.specialty.lower() in {"no specialty match", "aucune correspondance", "no match", ""}
