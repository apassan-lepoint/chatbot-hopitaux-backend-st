...
def sanity_check_message_pertinence_core(user_input, llm_service, pertinent_chatbot_use_case=False):
    """
    ...
    if pertinent_chatbot_use_case:
        is_off_topic = not llm_service.sanity_check_chatbot_pertinence(user_input)
        warning_msg = (
        ...
        is_off_topic = not llm_service.sanity_check_medical_pertinence(user_input)
